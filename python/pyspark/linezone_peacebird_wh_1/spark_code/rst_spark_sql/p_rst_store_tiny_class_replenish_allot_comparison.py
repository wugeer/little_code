...
# Filename: p_rst_store_tiny_class_replenish_allot_comparison
# Author: zsm
...
if __name__ == '__main__':
    ...
    sql_tmp1 = '''
        ...
        group by 
            a.store_code,store.city_long_code,store.zone_id,store.dq_long_code,a.year,a.quarter,a.tiny_class
    '''

    sql_insert = '''
        insert overwrite table {p_rst_schema}.rst_store_tiny_class_replenish_allot_comparison partition(day_date)
        select 
            tmp1.*
