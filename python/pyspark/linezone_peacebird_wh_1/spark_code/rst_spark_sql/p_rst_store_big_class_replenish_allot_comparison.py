...
# Filename: p_rst_store_big_class_replenish_allot_comparison
# Author: zsm
# Date: 2018/9/12 17:50
# ----------------------------------------------------------------------------
import os
...
if __name__ == '__main__':
    ...
    sql_tmp1 = '''
        ...
        group by 
            a.store_code,store.city_long_code,store.zone_id,store.dq_long_code,a.year,a.quarter,a.big_class
    '''

    sql_insert = '''
        insert overwrite table {p_rst_schema}.rst_store_big_class_replenish_allot_comparison partition(day_date)
        select 
            tmp1.*
