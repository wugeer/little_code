...
class MidDayEndStock:
    ...
    def execute_spark_sql(spark_session, **kwargs):
        ...
        # --  3.计算每天的库存
        sql_1 = """
                    insert overwrite table edw.mid_day_end_stock_lz
                    ...
                    --union all
                    --select * from edw.mid_day_end_stock_lz where stock_date <> {p_input_date}
        """.format(**kwargs)
