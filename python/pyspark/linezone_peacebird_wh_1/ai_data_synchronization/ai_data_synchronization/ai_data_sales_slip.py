...
from ai_data_synchronization.utils.tools import query_some_monday, query_day_date, \
    if_query_nothing, get_db_data, jm_md5, insert_db_df, delete_db_data
...
from ai_data_synchronization.exceptions.AiDataSynException import GetTokenException, DataSynException, SysException,\
    QueryNothingException, CleanDataException, DatabaseException


class AiDataSalesSlip(object):

    def __init__(self):
        self.header = AiDataSynConfig.HEADER
        self.secret = AiDataSynConfig.SECRET
        self.token_url = AiDataSynConfig.TOKEN_URL
        self.ai_data_syn_url = AiDataSynConfig.AI_DATA_SALES_SLIP_URL
